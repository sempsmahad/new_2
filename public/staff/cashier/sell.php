        ...
        <body>
                            ...
                            <div class="col-md-6">
                                <div class="card card-outline card-success">
                                    ...
                                    ?>
                                        ...
                                        <button type="submit" class="btn bg-gradient-success float-right" value="submit" id="itemsubmit">submit</button>
                                    </form>
            ...
            <?php require_once '../../../private/shared/cmn_scripts.php'; ?>
                <script>
                    ...
                    itemSubmit.addEventListener('onsubmit',e=>e.preventDefault())
